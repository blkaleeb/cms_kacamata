...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <form class="form-horizontal" action="controller/conn_add_pembelian.php" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="id_pembelian" name="id_pembelian" placeholder="ID Master Data" data-inputmask='"mask": "a{1,4}-9999"' data-mask>
                                    </div>
                                    <h3>Pihak Yang Melakukan Pembelian</h3>
                                    <div class="form-group row">
                                    <label for="inputWarna" class="col-sm-3 col-form-label">ID Karayawan</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="nama_karyawan" name="nama_karyawan"
                                                placeholder="Pilih ID Karyawan agar nama karyawan terisi" value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="nama_toko" placeholder="Nama Toko" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                                <input type="date" class="form-control" id="tgl_pembelian" name="tgl_pembelian" value=""/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="tgl_pengiriman" class="col-sm-3 col-form-label">Tanggal Pengiriman:</label>
                                        <div class="col-sm-3">
                                                <input type="date" class="form-control" id="tgl_pengiriman" name="tgl_pengiriman" value=""/>
                                        </div>
                                    </div>
                                    <!-- /.form-group -->
                                </div>
