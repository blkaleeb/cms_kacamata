...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah anda yakin menghapus data karyawan ini ?<br>
                        NIK &nbsp; :<b id="nik"></b><br>
                        Nama Karyawan &nbsp; :<b id="namaKaryawan"></b><br>
                        Jabatan &nbsp; :<b id="jabatan"></b></p>
                </div>
                <form action="controller/conn_delete_karyawan.php" method="post">
    ...
    <div class="modal fade" id="modal-edit-header">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="controller/conn_edit_karyawan.php" method="post">
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="nik" class="col-sm-12 col-form-label">NIK</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="nik1" name="nik1"
                                    placeholder="NIK Karyawan" value="" data-inputmask='"mask": "a{1,4}-9999"' data-mask>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="nama1" name="nama1"
                                    placeholder="Nama Karyawan" value="">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="jabatan" class="col-sm-12 col-form-label">Jabatan</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="jabatan1" name="jabatan1"
                                    placeholder="Jabatan Karyawan" value="">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="noTelp" class="col-sm-12 col-form-label">No Telp</label>
                            <div class="col-sm-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="alamat1" name="alamat1"
                                    placeholder="Alamat Karyawan" value="">
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modal-add">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Add - New Karyawan</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="controller/conn_add_karyawan.php" method="post">
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="nik" class="col-sm-12 col-form-label">NIK</label>
                            <div class="col-sm-12">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $d_head['nik']; ?></td>
                                                <td><?php echo $d_head['nama']; ?></td>
                                                <td><?php echo $d_head['jabatan']; ?></td>
                                                <td><?php echo $d_head['nomor_telp']; ?></td>
                                                <td><?php echo $d_head['alamat']; ?></td>
                                                <td>
                                                    <div class="row">

                                                        <button class="btn btn-info btn-sm" name="id_ev"
                                                            data-c="<?php echo $d_head['nik']; ?>"
                                                            data-e="<?php echo $d_head['nama']; ?>"
                                                            data-v="<?php echo $d_head['jabatan']; ?>"
                                                            data-i="<?php echo $d_head['nomor_telp']; ?>"
                                                            data-a="<?php echo $d_head['alamat']; ?>"
    ...
    <script>
        ...
        $('#modal-edit-header').on('show.bs.modal', function (event) {
            ...
            modal.find('.alamat1').val(recipient_a);
            ...
            document.getElementById("alamat1").value = recipient_a;
