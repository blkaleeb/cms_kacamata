...
while($d_head = mysqli_fetch_array($result_head)){
   $id_konsumen= $d_head['id_konsumen'];
   $nama_perusahaan= $d_head['nama_perusahaan'];
   $tanggal_pesan= $d_head['tanggal_pesan'];
   $batas_waktu= $d_head['batas_waktu'];
}
?>
<html lang="en">
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <form class="form-horizontal" action="controller/conn_edit_pesanan.php" method="post">
        <input type="hidden" class="form-control" name="idAwal" value="<?php echo $id_pesanan;?>">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Data Pesanan Barang
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="idPesanan" name="idPesanan"
                                            placeholder="Masukan ID Pesanan" value="<?php echo $id_pesanan; ?>" data-inputmask='"mask": "a{1,4}-9999"' data-mask>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <option value="" disabled>ID Konsumen</option>
                                            <?php 
                                            $no = 1;
                                            $result_head = mysqli_query($db2,"select * from `konsumen`");
                                            while($d_head = mysqli_fetch_array($result_head)){
                                               
                                            ?>
                                            <option value="<?php echo $d_head['id_konsumen']; ?>/<?php echo $d_head['nama_perusahaan']; ?>"
                                            <?php if ($d_head['id_konsumen']== $id_konsumen) {echo "selected";}?>>
                                                <?php echo $d_head['id_konsumen']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="namaKonsumen" name="namaKonsumen"
                                            placeholder="Pilih ID Konsumen agar nama konsumen terisi" value="<?php echo $nama_perusahaan; ?>" readonly>
                                    </div>
                                </div><br><br>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="date" class="form-control" id="tanggalMasuk" name="tanggalMasuk"
                                            placeholder="Tanggal Masuk" value="<?php echo $tanggal_pesan; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="batasWaktu" class="col-sm-3 col-form-label">Batas Waktu
                                        Pengiriman</label>
                                    <div class="col-sm-3">
                                        <input type="date" class="form-control" id="batasWaktu" name="batasWaktu"
                                            placeholder="Tanggal Batas Waktu" value="<?php echo $batas_waktu; ?>">
                                    </div>
                                </div>
                        </div>
                            ...
                            <?php
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <select name="account[<?php echo $x;?>]" id="account[<?php echo $x;?>]" class="form-control"
                                                style="width: 100%;" onChange="setBarang(this)">
                                                ...
                                                <?php 
                                                    ...
                                                    while($d_head = mysqli_fetch_array($result_head)){
                                                ?>
                                                <option value="<?php echo $d_head['id_barang']; ?>/<?php echo $d_head['nama_barang']; ?>/<?php echo $x; ?>"
                                                <?php if ($d_head['id_barang']==$dataJurnal['id_barang']) { echo "selected";}?>><?php echo $d_head['id_barang']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </td>
                                    <td>
                                        <input value="<?php echo $dataJurnal['nama_barang']; ?>" type="text" name="deskripsi[<?php echo $x;?>]" id="deskripsi[<?php echo $x;?>]" class="form-control" readonly>
                                    </td>
                                    <td><div class="row" style="margin:auto;"><input type="number" style="width: 80%;"
                                            id="inputHargaD<?php echo $x;?>" name="Debit[<?php echo $x;?>]"
                                            class="form-control" value="<?php echo $dataJurnal['jumlah_barang']; ?>" min=0><p style="margin:auto;"> Pcs</p></div></td>
                                </tr>
                                ...
                                <tr class='hidden'>
                                        ...
                                        <div class="form-group">
                                            <select name="account[<?php echo $i;?>]" id="account[<?php echo $i;?>]" class="form-control"
                                                ...
                                                <?php 
                                                    ...
                                                    while($d_head = mysqli_fetch_array($result_head)){
                                                ?>
                                                <option value="<?php echo $d_head['id_barang']; ?>/<?php echo $d_head['nama_barang']; ?>/<?php echo $i; ?>"><?php echo $d_head['id_barang']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </td>
                                    ...
                                    <td><div class="row" style="margin:auto;"><input type="number" style="width: 80%;"
                                            ...
                                            class="form-control" value="" min=0> <p style="margin:auto;"> Pcs</p></div></td>
                                </tr>
                                <?php }?>
                            </tbody>
