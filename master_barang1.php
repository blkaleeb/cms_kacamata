            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="emailPerusahaan1" name="emailPerusahaan1"
                ...
                <form action="controller/conn_add_konsumen.php" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="emailPerusahaan" class="col-sm-12 col-form-label">Email Perusahaan</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="emailPerusahaan" name="emailPerusahaan"
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $d_head['harga_barang']; ?></td>
                                                <td>
                                                    <ul>
                                                    <?php 
                                                        $result_master = mysqli_query($db2,"select * from `master_data` inner join bahan_baku
                                                        on bahan_baku.id_bahan_baku = master_data.id_bahan_baku where id_barang = $id_barang");
                                                        while($d_master = mysqli_fetch_array($result_master)){
                                                            echo "<li>".$d_master['nama_bahan_baku']."</li>";
                                                        }
                                                    ?>
                                                    </ul>
                                                 </td>
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <button class="btn btn-info btn-sm" name="id_ev"
                                                            data-c="<?php echo $d_head['id_konsumen']; ?>"
                                                            data-e="<?php echo $d_head['nama_barang']; ?>"
                                                            data-v="<?php echo $d_head['nama_barang']; ?>"
                                                            data-i="<?php echo $d_head['harga_barang']; ?>"
