...
<body class="hold-transition sidebar-mini layout-fixed"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Edit Data Kerusakan Bahan Baku</h4>
                ...
                <form action="controller/conn_edit_kerusakan.php" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="jumlah_kerusakan" class="col-sm-12 col-form-label">Jumlah Kerusakan Bahan Baku</label>
                            <div class="col-sm-12">
                                <input type="number" class="form-control" id="jumlah_kerusakan1" name="jumlah_kerusakan1"
                                    placeholder="Jumlah Kerusakan Bahan Baku" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="tanggal_kerusakan" class="col-sm-12 col-form-label">Tanggal Kerusakan Bahan Baku:</label>
                            <div class="col-sm-12">
                                <input type="date" class="form-control" id="tanggal_kerusakan1" name="tanggal_kerusakan1" value=""/>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <input class="jumlah_kerusakan2" type="hidden" id="jumlah_kerusakan2" name="jumlah_kerusakan2">
                        <input class="tanggal_kerusakan2" type="hidden" id="tanggal_kerusakan2" name="tanggal_kerusakan2">
    ...
    <div class="modal fade" id="modal-cancel">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah anda yakin menghapus data Kerusakan Bahan Baku ini ?<br>
                        ID Bahan Baku &nbsp; : &nbsp; <b id="idBahanBaku3"> </b><br>
                        Nama Bahan Baku &nbsp; : &nbsp; <b id="text_namabahanbaku"> </b><br>
                        Tanggal Pelaporan &nbsp; : &nbsp; <b id="tanggal_kerusakan3"></b><br>
                        Nama User &nbsp; : &nbsp; <b id="nama3"> </b> </p>
                </div>
                <form action="controller/conn_delete_kerusakan.php" method="post">
                    <input class="idBahanBaku3" type="hidden" name="idBahanBaku3">
                    <input class="jumlah_kerusakan3" type="hidden" name="jumlah_kerusakan3">
                    <input class="tanggal_kerusakan3" type="hidden" name="tanggal_kerusakan3">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <h3 style="padding-left: 20px;">Data Kerusakan Bahan Baku</h3>
                    ...
                    <div id="wrapper2" class="card-body" style="overflow-x:auto">
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th rowspan="2">No</th>
                                    <th rowspan="2">Jumlah Kerusakan Bahan Baku</th>
                                    <th rowspan="2">UOM</th>
                                    <th rowspan="2">Tanggal Kerusakan Bahan Baku</th>
                            ...
                            <tbody>
                            <?php
                                $sqlJurnal= mysqli_query($db2,"SELECT p.id_bahan_baku, b.nama_bahan_baku, p.nik, p.jumlah_kerusakan, b.uom, p.tanggal_pelaporan, u.nama
                                FROM kerusakan_bahan_baku as p
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $no; ?></td>
                                    <td><?php echo $dataJurnal['jumlah_kerusakan']; ?></td>
                                    <td><?php echo $dataJurnal['uom']; ?></td>
                                    <td><?php echo $dataJurnal['tanggal_pelaporan']; ?></td>
                                    ...
                                    <td>
                                        <div class="row">
                                            <button class="btn btn-info btn-sm" name="id_ev"
                                                ...
                                                data-e="<?php echo $dataJurnal['jumlah_kerusakan']; ?>"
                                                data-v="<?php echo $dataJurnal['uom']; ?>"
                                                data-i="<?php echo $dataJurnal['tanggal_pelaporan']; ?>"
    ...
    <script type="text/javascript">
        ...
        function setBahanBaku() {
            ...
            var arr_dataK = x.split('/');
            document.getElementById("nama_bahan_baku").value = arr_dataK[1];
            window.location.href = 'report_kerusakan.php?idBahanBaku='+arr_dataK[0];
        }
        ...
        $('#modal-cancel').on('show.bs.modal', function (event) {
            ...
            modal.find('.jumlah_kerusakan3').val(recipient_e);
            modal.find('.nama3').val(recipient_v);
            modal.find('.tanggal_kerusakan3').val(recipient_i);
            ...
            document.getElementById("tanggal_kerusakan3").innerHTML = recipient_i;
        ...
        $('#modal-edit-header').on('show.bs.modal', function (event) {
            ...
            modal.find('.jumlah_kerusakan1').val(recipient_e);
            modal.find('.uom1').val(recipient_v);
            modal.find('.tanggal_kerusakan1').val(recipient_i);
            modal.find('.nik1').val(recipient_a);

            document.getElementById("idBahanBaku1").value = recipient_c;
            document.getElementById("jumlah_kerusakan1").value = recipient_e;
            document.getElementById("uom1").value = recipient_v;
            document.getElementById("tanggal_kerusakan1").value = recipient_i;
            document.getElementById("nik1").value = recipient_a;

            // current value:
            document.getElementById("idBahanBaku2").value = recipient_c;
            document.getElementById("jumlah_kerusakan2").value = recipient_e;
            document.getElementById("tanggal_kerusakan2").value = recipient_i;
