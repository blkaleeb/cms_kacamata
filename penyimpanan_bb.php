...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <form class="form-horizontal" action="controller/conn_add_penyimpanan.php" method="post">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Dashboard Penyimpanan Bahan Baku
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3> Pihak yang Melakukan Penyimpanan </h3>
                                    ...
                                    <h3> Waktu Penyimpanan </h3>
                                    <div class="form-group row">
                                        <label for="tanggal_penyimpanan" class="col-sm-3 col-form-label">Tanggal Penyimpanan:</label>
                                        <div class="col-sm-3">
                                            <input type="date" class="form-control" id="tanggal_penyimpanan" name="tanggal_penyimpanan" value="" required/>
                                        </div>
                                    </div>
                                    <h3> Daftar Penyimpanan Bahan Baku </h3>
                                    <!-- /.form-group -->
                                </div>
                                <div class="col-12">
                                    <table id="listPenyimpanan" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>ID Bahan Baku</th>
                                                <th>Nama Bahan Baku</th>
                                                <th>Jumlah Penyimpanan Bahan Baku</th>
                                                <th>UOM</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr class="hidden">
                                                ...
                                                <td>
                                                    <div class="form-group">
															...
															style="width: 100%;" onChange="setPenyimpanan(this)">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" id="deskripsi[<?php echo $i;?>]" name="deskripsi[<?php echo $i;?>]" placeholder="Pilih ID Konsumen agar nama konsumen terisi" value="" readonly>
                                                </td>
                                                <td>
														<div class="row" style="margin:auto;"><input type="number"
                                            			id="inputHargaD<?php echo $i;?>" name="Debit[<?php echo $i;?>]"
                                           				class="form-control" value="" min=0> <p style="margin:auto;"></p>
														</div>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" id="uom[<?php echo $i;?>]" name="uom[<?php echo $i;?>]" placeholder="Pilih ID Konsumen agar nama konsumen terisi" value="" readonly>
                                                </td>
                                            </tr>
											<?php }?>																				
                                        </tbody>
                                    </table>
										<a class="btn btn-primary add_another" id="btnAddCol" onClick="$('#listPenyimpanan').find('tr.hidden:first').removeClass('hidden');"
