...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <form class="form-horizontal" action="controller/conn_edit_pembelian.php" method="post">
                ...
                <div class="container-fluid">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 for="id_pembelian">Nomor ID Pembelian:</h3>
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="id_pembelian" name="id_pembelian" placeholder="ID Master Data" value="<?php echo $id_pembelian?>">
                                    </div>
                                    <h3>Pihak Yang Melakukan Pembelian</h3>
                                    <div class="form-group row">
                                        <label for="inputWarna" class="col-sm-3 col-form-label">ID Karyawan</label>
                                        <div class="col-sm-9">
                                            <select class="form-control" style="width: 100%;" name="id_karyawan" id="id_karyawan" onChange="setKaryawan()">
                                            <option value="" disabled selected>ID Konsumen</option>
                                                <?php 
                                                $no = 1;
                                                ...
                                                <?php if ($d_head['nik']== $nik) {echo "selected";}?>>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="nama_karyawan" name="nama_karyawan"
                                                placeholder="Pilih ID Karyawan agar nama karyawan terisi" value="<?php echo $nama; ?>" readonly>
                                        </div>
                                    </div>
                                    <h3>Tempat Pembelian Bahan Baku</h3>
                                    <div class="form-group row">
                                        <label for="id_supplier" class="col-sm-3 col-form-label">Nomor ID Supplier</label>
                                        <div class="col-sm-9">
                                            <select class="form-control" style="width: 100%;" name="id_supplier" id="id_supplier" onChange="setSupplier()">
                                                <option value="" disabled selected>ID Supllier</option>
                                                    <?php 
                                                    $no = 1;
                                                    $result_head = mysqli_query($db2,"select * from `supplier`");
                                                    while($d_head = mysqli_fetch_array($result_head)){
                                                    ?>
                                                    <option value="<?php echo $d_head['id_supplier']; ?>/<?php echo $d_head['nama_toko']; ?>"
                                                    <?php if ($d_head['id_supplier']== $id_supplier) {echo "selected";}?>>
                                                        <?php echo $d_head['id_supplier']; ?></option>
                                                    <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="nama_toko" placeholder="Nama Toko" value="<?php echo $nama_toko?>" readonly>
                                        </div>
                                    </div>
                                    <h3>Periode Waktu Pesanan</h3>
                                    <div class="form-group row">
                                        <label for="tgl_pembelian" class="col-sm-3 col-form-label">Tanggal Pembelian:</label>
                                        <div class="col-sm-3">
                                                <input type="date" class="form-control" id="tgl_pembelian" name="tgl_pembelian" value="<?php echo $tanggal_pembelian; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="tgl_pengiriman" class="col-sm-3 col-form-label">Tanggal Pengiriman:</label>
                                        <div class="col-sm-3">
                                                <input type="date" class="form-control" id="tgl_pengiriman" name="tgl_pengiriman" value="<?php echo $tanggal_pengiriman; ?>"/>
                                        </div>
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                <div class="col-12">
                                    <table id="listPembelian" class="table table-bordered table-striped">
                                            ...
                                            <tr class=''>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <select name="account[<?php echo $x;?>]" id="account[<?php echo $x;?>]" class="form-control"
															style="width: 100%;" onChange="setBahanbaku(this)">
                                                ...
                                                <td>
                                                    <div class="row" style="margin:auto;"><input type="number" style="width: 80%;"
                                                        ...
                                                        class="form-control" value="<?php echo $dataJurnal['jumlah_pembelian']; ?>" min=0><p style="margin:auto;"> Pcs</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" id="uom[<?php echo $x;?>]" name="uom[<?php echo $x;?>]" value="<?php echo $dataJurnal['uom']; ?>" readonly>
                                                </td>
                                            </tr>
                                            <?php $x++;} 
                                                for ($i=$x; $i <= 50; $i++) { 
										...
										<a class="btn btn-primary add_another" id="btnAddCol" onClick="$('#listPembelian').find('tr.hidden:first').removeClass('hidden');"
