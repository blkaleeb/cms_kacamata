...
<body class="hold-transition sidebar-mini layout-fixed" onLoad="$('#example1').find('tr.hidden:first').removeClass('hidden');">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="idPesanan" name="idPesanan"
                                            placeholder="Masukan ID Pesanan" value="" data-inputmask='"mask": "a{1,4}-9999"' data-mask>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="date" class="form-control" id="tanggalMasuk" name="tanggalMasuk"
                                            placeholder="Tanggal Masuk" value="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="date" class="form-control" id="batasWaktu" name="batasWaktu"
                                            placeholder="Tanggal Batas Waktu" value="">
                                    </div>
                                </div>
