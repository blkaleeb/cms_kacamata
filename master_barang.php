...
<body class="hold-transition sidebar-mini layout-fixed" onLoad="$('#example1').find('tr.hidden:first').removeClass('hidden');">
    ...
    <div class="wrapper">
        ...
        <form class="form-horizontal" action="controller/conn_add_master_data.php" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="idPesanan" name="idPesanan"
                                            placeholder="Masukan ID Master Data" value="" data-inputmask='"mask": "a{1,4}-9999"' data-mask>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <option value="" disabled selected>ID Barang</option>
                                            <?php 
                                            $no = 1;
                                            $result_head = mysqli_query($db2,"select * from `barang` where id_barang not in (select id_barang from master_data)");
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="namaKonsumen" name="namaKonsumen"
                                            placeholder="Pilih ID Barang agar nama barang terisi" value="" readonly>
                                    </div>
                                </div><br><br>
