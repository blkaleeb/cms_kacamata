...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <form class="form-horizontal" action="controller/conn_add_pengambilan.php" method="post">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Dashboard Pengambilan Bahan Baku
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3> Pihak yang Melakukan Pengambilan </h3>
                                    ...
                                    <div class="form-group row">
                                        <label for="tanggal_pengambilan" class="col-sm-3 col-form-label">Tanggal Pengambilan:</label>
                                        <div class="col-sm-3">
                                            <input type="date" class="form-control" id="tanggal_pengambilan" name="tanggal_pengambilan" value="" required/>
                                        </div>
                                    </div>
                                    <h3> Daftar Pengambilan Bahan Baku </h3>
                                    <!-- /.form-group -->
                                </div>
                                <div class="col-12">
                                    <table id="listPengambilan" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>ID Bahan Baku</th>
                                                <th>Nama Bahan Baku</th>
                                                <th>Jumlah Pengambilan Bahan Baku</th>
                                                <th>UOM</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr class="hidden">
                                                ...
                                                <td>
                                                    <div class="form-group">
															...
															style="width: 100%;" onChange="setPengambilan(this)">
                                                            <option value="" disabled selected>Pilih Bahan Baku</option>
                                                            <?php 
                                                            $result_head = mysqli_query($db2,"SELECT b.id_bahan_baku, b.nama_bahan_baku, b.stok_bahan_baku, b.uom, b.minimum_stock, kerusakan.TotalKerusakan, (penyimpanan.TotalPenyimpanan-pengambilan.TotalPengambilan-kerusakan.TotalKerusakan) TotalStok
                                                            ...
                                                            while($d_head = mysqli_fetch_array($result_head)){
                                                            // $stok_temp = $d_head['stok_bahan_baku'];
                                                            ?>
                                                            <option value="<?php echo $d_head['id_bahan_baku'];?>/<?php echo $d_head['nama_bahan_baku']; ?>/<?php echo $d_head['uom']; ?>/<?php echo $i; ?>/<?php echo $d_head['TotalStok']; ?>">
                                                ...
                                                <td>
														<div class="row" style="margin:auto;">
                                                            ...
                                                            id="Debit[<?php echo $i;?>]" name="Debit[<?php echo $i;?>]"
                                                            class="form-control" value="" min=0 max="">
														</div>
                                                </td>
                                                <td>
										...
										<a class="btn btn-primary add_another" id="btnAddCol" onClick="$('#listPengambilan').find('tr.hidden:first').removeClass('hidden');"
    ...
    <script type="text/javascript">
        ...
        document.getElementById("Debit["+arr_dataB[3]+"]").setAttribute('max',arr_dataB[4]);
