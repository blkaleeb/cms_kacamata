...
session_start();
    ...
    $id_karyawanX = $arr2[0];
    $tgl_pelaporan = $_POST['tanggal_pelaporan'];
    ...
    foreach($account as $key => $account_v) {
        ...
        $stmt1 = $db2->prepare("INSERT INTO `kerusakan_bahan_baku` (id_bahan_baku, nik, jumlah_kerusakan, tanggal_pelaporan) VALUES(?, ?, ?, ?)");
        $stmt1->bind_param("ssss", $account_vX, $id_karyawanX, $debit_v, $tgl_pelaporan);
